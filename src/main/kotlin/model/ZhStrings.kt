...
class ZhStrings : Strings {
    ...
    override val fileDragToCopy = "拖动复制"
    ...
    override fun editorPosition(line: Int, column: Int, lines: Int, characters: Int) =
        "第 $line 行，第 $column 列  ·  共 $lines 行  ·  $characters 个字符"
    override val editorUndo = "撤销"
    override val editorRedo = "重做"
    override val editorFind = "查找"
    override val editorFindNext = "查找下一个"
    override val editorReplace = "替换"
    override val editorReplaceWith = "替换为"
    override val editorReplaceAll = "全部替换"
    override val editorNoMatch = "未找到"
    override val editorCloseFind = "关闭查找"
    override val editorDiscardTitle = "放弃未保存的修改？"
    override val editorDiscardMessage = "关闭后，本次修改将无法恢复。"
    override val editorDiscard = "放弃修改"
    override val editorContinueEditing = "继续编辑"
    override fun editorUnsupportedEncoding(encoding: String) = "不支持的编码：$encoding"
    override fun editorReloadEncodingFailed(encoding: String, error: String) =
        "使用 $encoding 重新读取失败：$error"
    override fun editorSavedAsUtf8(originalEncoding: String) =
        "保存成功；$originalEncoding 无法表示全部字符，已自动改用 UTF-8"
    ...
    override val terminalTitle = "终端"
    override val terminalOpen = "打开终端"
    override val terminalHint = "输入 Shell 命令；以 adb 开头可执行 ADB 命令。\n示例：pwd、ls -la /sdcard、adb devices"
    override val terminalCommand = "命令"
    override val terminalPlaceholder = "pwd  或  adb devices"
    override val terminalRun = "运行"
    override val terminalClear = "清屏"
    override val terminalClose = "关闭终端"
    override val terminalNew = "新建终端标签"
    override val terminalFilesTab = "文件管理"
    override val panelLeft = "本地电脑"
    override val panelRight = "Android 设备"
    override val panelCopyToOther = "复制到另一侧"
    override val panelMoveToOther = "移动到另一侧"
    override val localCopyToAndroid = "复制到 Android"
    override val localDirectoryReadOnly = "当前目录只读"
    override val localPaneCollapse = "折叠本地栏"
    override val localPaneExpand = "展开本地栏"
    override fun localDirectoryNotFound(path: String) = "本地目标目录不存在：$path"
    override fun localDestinationNotDirectory(path: String) = "本地目标不是目录：$path"
    override fun localDirectoryNotWritable(path: String) = "本地目录不可写，请进入自己的用户目录或其他可写目录后重试：$path"
